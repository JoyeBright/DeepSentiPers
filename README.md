...
:information_source: We're glad to inform you that DeepSentiPers has also been drafted in Persian. See it at https://zenodo.org/record/3551273. Note that the intended version has slightly different from the English one. 
